...
export default function Page() {
  ...
  const moods = [{ mood: "neutral", icon: IconMoodNeutral }, { mood: "happy", icon: IconMoodHappy }, { mood: "sad", icon: IconMoodSad }, { mood: "angry", icon: IconMoodAngry }];
        ...
        <div className="p-8 flex flex-col gap-3">
          <div className="border-2 gap-1 p-2 pl-4 pr-4 flex items-center justify-between border-[#007EFF] bg-white rounded-md  shadow-2xs">
            <div className="flex flex-col gap-1  text-xl font-bold">
              ...
              <p className="text-sm font-normal flex items-center text-black/80">
                <Calendar className="p-1" /> {fDate}
              </p>
            </div>

            <div className="bg-[#007EFF]/5  rounded-md p-6 h-full border-[#007EFF] border-2">
          ...
          <div className="h-[12vh]  flex gap-2">
            <div className="h-full flex flex-col justify-center items-center  border-[#007EFF] border-2   rounded-md bg-white w-[33%]">
              ...
              <p className="text-sm font-normal text-black/80">Days Active</p>
            </div>
            ...
            <div className="h-full flex flex-col justify-center items-center border-[#007EFF] border-2   rounded-md bg-white w-[33%]">
              ...
              <p className="text-sm font-normal text-black/80">Current Mood</p>
            </div>

            <div className="h-full flex flex-col justify-center items-center  border-[#007EFF] border-2   rounded-md bg-white w-[33%]">
              <p className="text-xl font-bold text-[#007EFF]">15</p>
              <p className="text-sm font-normal text-black/80">News Viewed</p>
            </div>
          </div>
            ...
            <div className="border-2 w-full p-4 flex flex-col gap-4  border-[#007EFF] bg-white rounded-md ">
              ...
              <div className="flex flex-col gap-2">
                {healthTips.map((tip, index) => (
                  <p
                    className="text-sm flex  items-center gap-2 font-medium p-4 rounded-md border-[#007EFF]/50 border-2 bg-[#007EFF]/5"
                    key={tip}
                  >
                    <p className="p-2 flex justify-center items-center w-[7%] rounded-md bg-[#007EFF] text-white">
                      {index + 1}
                    </p>
                    <p className="text-sm font-normal">{tip}</p>
                  </p>
                ))}
              </div>
            </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-semibold">
                          {moodx.mood.charAt(0).toUpperCase() + moodx.mood.slice(1)}
                        </p>
                      </div>
